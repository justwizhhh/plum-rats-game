...
public class AudioManager : MonoBehaviour
{
    ...
    public IEnumerator PlaySound(string soundName, float volume = 0)
    {
    ...
    public void PlayMusic(string musicName, float volume = 0)
    {
    ...
    public void ResetMusicVolume() { musicSource.volume = MusicVolume; }
}
